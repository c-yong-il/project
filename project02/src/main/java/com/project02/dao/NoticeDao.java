...
import com.project02.vo.NoticeVO;
...
public class NoticeDao extends DBConn {
    ...
    public int insert(NoticeVO vo) {
        int result = 0;
        String sql = "insert into notice_table values('n_'||sequ_notice_table.nextval,?,?,1,0,'test1',sysdate-1,'test1',sysdate)";
    ...
    public ArrayList<NoticeVO> select() {
        ...
        String sql = "select rownum rno, notice_id, ntitle, ncontent, notice_hits, notice_status, "
                ...
                + " mem_id1, notice_date, mem_id2, notice_updatedate from notice_table order by notice_date desc)";
        getPreparedStatement(sql);
        try {
